...
-(void)datePickerDonePressed:(THDatePickerViewController *_Nullable)datePicker;
-(void)datePickerCancelPressed:(THDatePickerViewController *_Nullable)datePicker;

@optional

-(void)datePicker:(THDatePickerViewController *_Nullable)datePicker selectedDate:(NSDate *_Nullable)selectedDate;
-(void)datePicker:(THDatePickerViewController *_Nullable)datePicker deselectedDate:(NSDate *_Nullable)deselectedDate;
-(void)datePickerDidHide:(THDatePickerViewController *_Nullable)datePicker;
-(void)datePicker:(THDatePickerViewController *_Nullable)datePicker changedMonth:(NSInteger)month year:(NSInteger)year;
...
@property (strong, nonatomic) UIColor * _Nullable selectedBackgroundColor;
@property (strong, nonatomic) UIColor * _Nullable currentDateColor;
@property (strong, nonatomic) UIColor * _Nullable currentDateColorSelected;
@property (nonatomic) float autoCloseCancelDelay;
@property (strong, nonatomic) NSTimeZone * _Nullable dateTimeZone;
...
- (void)setDateHasItemsCallback:(BOOL (^_Nullable)(NSDate * _Nullable date))callback;
 ...
 * \return successful?
 */
- (BOOL)setDateTimeZoneWithName:(NSString *_Nullable)name;
 ...
 */
- (void)setDateRangeFrom:(NSDate *_Nullable)fromDate toDate:(NSDate *_Nullable)toDate;

/*! Set calendar title
 * \param dateTitle     calendar title
 */
- (void)setDateTitle:(NSString*_Nullable)dateTitle;
