...
-(BOOL)validate{
    ...
    self.rightView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 10, 25)];
    return YES;
}
...
-(void)showErrorIconForMsg:(NSString *)msg{
    UIView *viewError = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 35, 25)];
    UIButton *btnError=[[UIButton alloc] initWithFrame:CGRectMake(5, 0, 25, 25)];
    ...
    [viewError addSubview:btnError];
    self.rightView=viewError;
