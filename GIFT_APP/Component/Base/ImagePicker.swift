...
open class ImagePicker: NSObject {
    ...
    private func pickerController(_ controller: UIImagePickerController, didSelect image: UIImage?, imageURL url: URL?) {
...
extension ImagePicker: UIImagePickerControllerDelegate {
    ...
    public func imagePickerController(_ picker: UIImagePickerController,
        ...
        self.pickerController(picker, didSelect: image, imageURL: info[.imageURL] as? URL)
    }
