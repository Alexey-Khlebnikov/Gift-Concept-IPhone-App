...
extension RestManager {
    struct FileInfo {
        ...
        init(withFileURL url: URL?, filename: String, name: String, mimetype: String) {
            ...
            setInfo(withFileData: data, filename: filename, name: name, mimetype: mimetype)
        }
        ...
        mutating func setInfo(withFileData data: Data?, filename: String, name: String, mimetype: String) {
