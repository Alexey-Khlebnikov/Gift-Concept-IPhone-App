...
open class Select2 : TextFieldValidator{
...
//extension Select2 : UITextFieldDelegate {
...
extension Select2: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if imageArray.count >= indexPath.item + 1 {
...
extension Select2: UITableViewDelegate {
